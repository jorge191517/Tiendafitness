...
export default function Brands() {
  ...
  const brandsSection = slogans?.brands ?? {};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-4 md:gap-6">
          {brands.map((brand, i) => (
            ...
            >
              <div className="w-14 h-14 md:w-16 md:h-16 rounded-xl bg-[#111827] flex items-center justify-center mb-3 transition-all duration-500 group-hover:bg-electric/10 group-hover:shadow-[0_0_20px_rgba(0,153,255,0.2)] grayscale group-hover:grayscale-0 border border-white/[0.06]">
