...
/**
 * Productos de la categoría Suplementos.
...
export const suplementosProducts: Product[] = [
  {
    ...
    description:
      "Proteína de suero aislada de alta pureza con 27g de proteína por toma. Baja en grasas y carbohidratos, sabor premium.",
    price: 59.99,
    oldPrice: 79.99,
    image:
  ...
  },
  {
    ...
    slug: "complejo-recuperador-bcaa",
    category: "suplementos",
    description:
      "BCAAs en proporción 2:1:1 con glutamina y vitamina B6. Acelera la recuperación y reduce la fatiga muscular.",
    price: 34.99,
    image:
