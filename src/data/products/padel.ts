...
/**
 * Productos de la categoría Pádel.
...
export const padelProducts: Product[] = [
  {
    ...
    slug: "pala-padel-carbono-pro",
    category: "padel",
    description:
      "Pala de pádel fabricada en carbono de alta resistencia con núcleo de goma EVA. Potencia y control en cada golpe.",
    price: 189.99,
    oldPrice: 249.99,
    image:
